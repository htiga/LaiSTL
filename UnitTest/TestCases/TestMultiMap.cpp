...
// http://llvm.org/svn/llvm-project/libcxx/trunk/test/std/containers/associative/multimap/
#include "stdafx.h"
...
#define MAP lai::multimap
#define S_MAP std::multimap
...
namespace UnitTest
{
    ...
    TEST_CLASS(TestMultiMap)
    {
        ...
        // http://llvm.org/svn/llvm-project/libcxx/trunk/test/std/containers/associative/multimap/multimap.cons/default_recursive.pass.cpp
        struct X
        {
            MAP<int, X> m;
        ...
        {
            {
                ...
                IS_TRUE(m.size() == 3);
                IS_TRUE(next(m.begin(), 2)->first == 1);
                IS_TRUE(next(m.begin(), 2)->second == DefaultOnly());
                IS_TRUE(DefaultOnly::count == 3);
            }
            IS_TRUE(DefaultOnly::count == 0);
            {
                ...
                IS_TRUE(m.size() == 3);
                IS_TRUE(r->first == 1);
                IS_TRUE(r->second == MoveOnly(3, 3.5));
            }
            {
        ...
        {
            {
                ...
                IS_TRUE(next(m.begin())->first == 1);
                IS_TRUE(next(m.begin())->second == 1.5);
                IS_TRUE(next(m.begin(), 2)->first == 1);
                IS_TRUE(next(m.begin(), 2)->second == 2);
                IS_TRUE(next(m.begin(), 3)->first == 2);
                IS_TRUE(next(m.begin(), 3)->second == 1.5);
                IS_TRUE(next(m.begin(), 4)->first == 2);
                IS_TRUE(next(m.begin(), 4)->second == 2);
                IS_TRUE(next(m.begin(), 5)->first == 3);
                IS_TRUE(next(m.begin(), 5)->second == 1);
                IS_TRUE(next(m.begin(), 6)->first == 3);
                IS_TRUE(next(m.begin(), 6)->second == 1.5);
                IS_TRUE(next(m.begin(), 7)->first == 3);
                IS_TRUE(next(m.begin(), 7)->second == 2);

                i = m.erase(next(m.cbegin(), 0));
                IS_TRUE(m.size() == 7);
                IS_TRUE(i == m.begin());
                IS_TRUE(next(m.begin(), 0)->first == 1);
                IS_TRUE(next(m.begin(), 0)->second == 1.5);
                IS_TRUE(next(m.begin(), 1)->first == 1);
                IS_TRUE(next(m.begin(), 1)->second == 2);
                IS_TRUE(next(m.begin(), 2)->first == 2);
                IS_TRUE(next(m.begin(), 2)->second == 1.5);
                IS_TRUE(next(m.begin(), 3)->first == 2);
                IS_TRUE(next(m.begin(), 3)->second == 2);
                IS_TRUE(next(m.begin(), 4)->first == 3);
                IS_TRUE(next(m.begin(), 4)->second == 1);
                IS_TRUE(next(m.begin(), 5)->first == 3);
                IS_TRUE(next(m.begin(), 5)->second == 1.5);
                IS_TRUE(next(m.begin(), 6)->first == 3);
                IS_TRUE(next(m.begin(), 6)->second == 2);

                i = m.erase(next(m.cbegin(), 5));
                IS_TRUE(m.size() == 6);
                IS_TRUE(i == prev(m.end()));
                IS_TRUE(next(m.begin(), 0)->first == 1);
                IS_TRUE(next(m.begin(), 0)->second == 1.5);
                IS_TRUE(next(m.begin(), 1)->first == 1);
                IS_TRUE(next(m.begin(), 1)->second == 2);
                ...
                IS_TRUE(next(m.begin(), 4)->second == 1);
                IS_TRUE(next(m.begin(), 5)->first == 3);
                IS_TRUE(next(m.begin(), 5)->second == 2);
                ...
                IS_TRUE(next(m.begin(), 0)->first == 1);
                IS_TRUE(next(m.begin(), 0)->second == 1.5);
                IS_TRUE(next(m.begin(), 1)->first == 2);
                IS_TRUE(next(m.begin(), 1)->second == 1.5);
                IS_TRUE(next(m.begin(), 2)->first == 2);
                IS_TRUE(next(m.begin(), 2)->second == 2);
                IS_TRUE(next(m.begin(), 3)->first == 3);
                IS_TRUE(next(m.begin(), 3)->second == 1);
                IS_TRUE(next(m.begin(), 4)->first == 3);
                IS_TRUE(next(m.begin(), 4)->second == 2);
                ...
                IS_TRUE(next(m.begin(), 0)->first == 2);
                IS_TRUE(next(m.begin(), 0)->second == 1.5);
                IS_TRUE(next(m.begin(), 1)->first == 3);
                IS_TRUE(next(m.begin(), 1)->second == 2);
        ...
        {
            {
                ...
                IS_TRUE(i == 3);
                IS_TRUE(next(m.begin(), 0)->first == 1);
                IS_TRUE(next(m.begin(), 0)->second == 1);
                IS_TRUE(next(m.begin(), 1)->first == 1);
                IS_TRUE(next(m.begin(), 1)->second == 1.5);
                IS_TRUE(next(m.begin(), 2)->first == 1);
                IS_TRUE(next(m.begin(), 2)->second == 2);
                ...
                IS_TRUE(next(m.begin(), 3)->second == 1);
                IS_TRUE(next(m.begin(), 4)->first == 3);
                IS_TRUE(next(m.begin(), 4)->second == 1.5);
                IS_TRUE(next(m.begin(), 5)->first == 3);
                IS_TRUE(next(m.begin(), 5)->second == 2);
        ...
        TEST_METHOD(TestInsertInitList)
        {
            ...
            IS_TRUE(m.size() == 9);
            IS_TRUE(distance(m.begin(), m.end()) == 9);
        ...
        TEST_METHOD(TestInsertHintCv)
        {
            ...
            IS_TRUE(r == prev(m.end(), 2));
            IS_TRUE(m.size() == 4);
            IS_TRUE(r->first == 3);
            IS_TRUE(r->second == 4.5);
        }
        ...
        TEST_METHOD(TestInsertRange)
        {
            ...
            IS_TRUE(next(m.begin(), 4)->first == 2);
            IS_TRUE(next(m.begin(), 4)->second == 1.5);
            IS_TRUE(next(m.begin(), 5)->first == 2);
            IS_TRUE(next(m.begin(), 5)->second == 2);
            IS_TRUE(next(m.begin(), 6)->first == 3);
            IS_TRUE(next(m.begin(), 6)->second == 1);
            IS_TRUE(next(m.begin(), 7)->first == 3);
            IS_TRUE(next(m.begin(), 7)->second == 1.5);
            IS_TRUE(next(m.begin(), 8)->first == 3);
            IS_TRUE(next(m.begin(), 8)->second == 2);
        }
        ...
        TEST_METHOD(TestEqualRange)
        {
            typedef std::pair<const int, double> V;
            {
                typedef MAP<int, double> M;
                {
                    ...
                    r = m.equal_range(9);
                    IS_TRUE(r.first == next(m.begin(), 6));
                    IS_TRUE(r.second == next(m.begin(), 9));
                    r = m.equal_range(10);
                    IS_TRUE(r.first == m.end());
                    IS_TRUE(r.second == m.end());
                }
                {
